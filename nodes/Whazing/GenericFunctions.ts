...
const API_MESSAGE_TRANSLATIONS: Array<[string, string]> = [
	...
	['ticket não encontrado',   'Ticket não encontrado — verifique o ID do ticket informado'],
	['ticket nao encontrado',   'Ticket não encontrado — verifique o ID do ticket informado'],
	['anotação não encontrada', 'Anotação não encontrada — verifique o ID da anotação informado'],
	['anotacao nao encontrada', 'Anotação não encontrada — verifique o ID da anotação informado'],
	['note not found',           'Anotação não encontrada — verifique o ID da anotação informado'],
